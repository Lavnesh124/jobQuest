...
const RegisterCompany = () => {
    ...
    const handleCreate = async (e) => {
        ...
        const addCompany = { companyname: companyname, website: website, location: location,description:description };
        console.log(addCompany);
        const response = await fetch("http://localhost:8021/api/v1/company/register", {
          method: "POST",
    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-13rem)] bg-gray-100 p-10">
            ...
            >
                ...
                <div className="mb-4">
                    <label className="block text-sm font-semibold mb-2" htmlFor="location">Discription</label>
                    <input
                        type="text"
                        id="description"
                        value={description}
